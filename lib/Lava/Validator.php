...
class Validator {
    ...
    static
    public function is_int ($val, $size = 4, $unsigned = FALSE) {
    ...
    static
    public function is_tinyint   ($val, $unsigned = FALSE) {
        return self::is_int($val, 1, $unsigned);
    }
    static
    public function is_smallint  ($val, $unsigned = FALSE) {
        return self::is_int($val, 2, $unsigned);
    }
    static
    public function is_mediumint ($val, $unsigned = FALSE) {
        return self::is_int($val, 3, $unsigned);
    }
    static
    public function is_integer   ($val, $unsigned = FALSE) {
        return self::is_int($val, 4, $unsigned);
    }
    static
    public function is_bigint    ($val, $unsigned = FALSE) {
        return self::is_int($val, 8, $unsigned);
    }

    static
    public function is_numeric   ($val, $prec = 0, $scale = 0) {
    ...
    static
    public function is_string ($val, $min, $max = NULL) {
    ...
    static
    public function is_char ($val, $size = 1) {
    ...
    static
    public function is_lt  ($val, $num = 0) {
        return is_numeric($val) && $val <  $num;
    }
    static
    public function is_lte ($val, $num = 0) {
        return is_numeric($val) && $val <= $num;
    }
    static
    public function is_gt  ($val, $num = 0) {
        return is_numeric($val) && $val >  $num;
    }
    static
    public function is_gte ($val, $num = 0) {
        return is_numeric($val) && $val >= $num;
    }
}
